...
import { RentType, WhomType } from './Description.type';
				...
				<div className={cx('description__wrapper')}>
					...
					<article className={cx(`description__content`, `${revers ? 'reverse' : ''}`)} >
						...
						<div className={cx('description__image')}>
							<Image className={cx('description__image')} src={revers ? descriptionData.rent.image : descriptionData.whom.image} alt='auto' />
						</div>
					</article>
				</div>
			</Container>
